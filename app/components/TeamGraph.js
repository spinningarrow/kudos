// This is a very quick and dirty wrapper around the d3 force graph from
// divisions.js
...
var TeamGraph = React.createClass({
	...
	render: function () {
		...
		var that = this;
				...
				var groupsMap = _.groupBy(this.props.data, function (user) {
		...
		function click(d) {
			...
			if (d.children) {
				...
				if (!d._children) {
					...
					that.props.handleLeafNodeClick(d);
				}
